...
#define VERIFY_PKT_RESPONSE_MSG_FROM_VERIFY_SERVER_POSITION 14
#define VERIFY_PKT_RESPONSE_MSG_FROM_VERIFY_SERVER_LENGTH 46
...
struct VerifyPacketHeader{
	char msg[VERIFY_PKT_MSG_TYPE_LENGTH+1];
