...
#define VERIFY_PKT_HEADER_LENGTH (VERIFY_PKT_MSG_TYPE_LENGTH+VERIFY_PKT_TERMINAL_ID_LENGTH+VERIFY_PKT_WORKER_ID_LENGTH+VERIFY_PKT_RESPONSE_MSG_TYPE_FROM_VERIFY_SERVER_LENGTH+VERIFY_PKT_RESPONSE_MSG_FROM_VERIFY_SERVER_LENGTH+VERIFY_PKT_PAYLOAD_LEN_LENGTH)
